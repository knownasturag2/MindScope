"""
Django settings for Software Engineering project.
...
SECRET_KEY = 'django-insecure-k1cuo518lqcnb+lc*mrg^dx+qhv_b76(*0gjv8ih__x9231&&g'
...
INSTALLED_APPS = [
    ...
    'Mindscope.apps.MindscopeConfig',
]
